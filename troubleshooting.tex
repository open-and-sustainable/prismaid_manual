...
\tip{For cost-sensitive projects, run a small test first with 5-10 papers and examine the log output (set `log\_level = "medium"`) to see token usage and estimated costs per paper.}
