...
\begin{commandbox}[R Code for Analyzing Model Agreement: Part 1]
...
\end{lstlisting}
\end{commandbox}
\begin{commandbox}[R Code for Analyzing Model Agreement: Part 2]
\begin{lstlisting}[language=R]
...
\begin{commandbox}[Python Code for Visualizing Ensemble Agreement: Part 1]
...
\end{lstlisting}
\end{commandbox}
\begin{commandbox}[Python Code for Visualizing Ensemble Agreement: Part 2]
\begin{lstlisting}[language=Python]
...
\begin{commandbox}[Python Code for Majority Voting: Part 1]
\begin{lstlisting}[language=Python]
import pandas as pd
...
\end{lstlisting}
\end{commandbox}
\begin{commandbox}[Python Code for Majority Voting: Part 2]
\begin{lstlisting}[language=Python]
