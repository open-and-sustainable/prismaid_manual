...
\newcommand{\customtitle}{
    \begin{titlepage}
        ...
        {\Large\textit{Riccardo Boero}}\\[0.5cm]
        \texttt{ribo@nilu.no}\\[6cm]
        {\large\today}\\[0.5cm]  % Email
        {\large Version: \docversion}\\[1cm]  % tagged version
        DOI: \href{https://doi.org/10.xxxx/xxxxx}{10.xxxx/xxxxx}  % DOI link
        \vfill
    \end{titlepage}
