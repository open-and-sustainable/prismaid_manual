...
\begin{commandbox}[Example URL List File: paper_urls.txt]
\begin{lstlisting}
...
\note{Extracting numerical data from free-text fields like `yield_impact` may require additional processing before quantitative analysis.}
