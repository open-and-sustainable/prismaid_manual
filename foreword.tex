...
\begin{infobox}[Example of a Literature Search Query]
\begin{lstlisting}
...
This manual provides a complete overview of the features available in \texttt{prismAId} version ≥ 0.9.0. However, many aspects also apply to earlier versions that offer the same features.
